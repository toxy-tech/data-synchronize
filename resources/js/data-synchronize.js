$(() => {
        ...
        httpClient
            ...
            .then(async ({ headers, data }) => {
                if (headers['content-disposition'] === undefined) {
                    ...
                    ToxyTech.showError(responseJson?.message || $form.data('error-message'))
                ...
                ToxyTech.showSuccess($form.data('success-message'))
            })
            .catch((error) => {
                console.log(error)
                ToxyTech.showError($form.data('error-message'))
            })
    }
    ...
    if ($form.length > 0) {
        ...
        const cleanup = () => {
            ToxyTech.hideButtonLoading($button)
        ...
        dropzone.on('sending', () => {
            ...
            ToxyTech.showButtonLoading($button)
        })
