...
namespace ToxyTech\DataSynchronize\Exporter;

use ToxyTech\Base\Facades\Assets;
use ToxyTech\Base\Facades\BaseHelper;
use ToxyTech\DataSynchronize\Concerns\Exporter\HasEmptyState;
use ToxyTech\DataSynchronize\Enums\ExportColumnType;
use Carbon\Carbon;
...
abstract class Exporter implements FromCollection, ShouldAutoSize, WithColumnFormatting, WithEvents, WithHeadings, WithMapping
{
    ...
    /**
     * @return \ToxyTech\DataSynchronize\Exporter\ExportColumn[]
     */
    ...
    /**
     * @return \ToxyTech\DataSynchronize\Exporter\ExportCounter[]
     */
